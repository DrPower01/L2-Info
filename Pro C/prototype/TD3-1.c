...
// Procédure pour afficher l'arbre (parcours en ordre infixé )
...
// Procédure pour afficher la racine de l'arbre
...
int main() {
    ...
    printf("Affichage de l'arbre en ordre infixé:\n");
    ...
    // Parcours en ordre préfixe de l'arbre
    printf("Parcours en ordre préfixe de l'arbre : ");
